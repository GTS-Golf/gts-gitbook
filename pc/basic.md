...
<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609_01 (1).png" alt=""><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609_02 (1).png" alt=""><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609_03 (1).png" alt=""><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101537105.png" alt=""><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609.png" alt=""><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609_02.png" alt=""><figcaption></figcaption></figure>

<div>

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609_01.png" alt=""><figcaption></figcaption></figure>

 

<figure><img src="../.gitbook/assets/KakaoTalk_20240122_101532609_03.png" alt=""><figcaption></figcaption></figure>
...
파이썬 라이브러리에는 작업 생성 함수로 노드를 추가할 수 있는 _default graph_라는 것이 있습니다. default graph는 다양하게 이용하기 좋습니다. [Graph class](../index-3/index/framework.md#Graph) 문서에서 여러 그래프를 명시적으로 관리하는 방법을 알 수 있습니다.
...
graph를 구성하고 나면 `Session` 오브젝트를 만들어서 graph를 실행할 수 있습니다. op 생성함수에서 다른 graph를 지정해줄 때까지는 default graph가 `Session`에서 실행됩니다. 관련 내용은 [Session class](../index-3/index/client.md#session-management)에서 확인할 수 있습니다.
...
이 문서에 있는 파이썬 예제들은 [`Session`](../index-3/index/client.md#Session)을 실행시키고 [`Session.run()`](../index-3/index/client.md#Session.run) 메서드를 이용해서 graph의 작업들을 처리한다.

[IPython](http://ipython.org)같은 인터렉티브 파이썬 환경에서의 이용편의성을 위해[`InteractiveSession`](../index-3/index/client.md#InteractiveSession)클래스와 [`Tensor.eval()`](../index-3/index/framework.md#Tensor.eval),[`Operation.run()`](../index-3/index/framework.md#Operation.run) 메서드를 대신 이용할 수도 있다. session 내에서 변수를 계속 유지할 필요가 없기 때문이다.
...
그래프를 실행하더라도 변수(variable)의 상태는 유지됩니다. 아래에서 간단한 카운터 예제를 통해 변수에 대해서 알 수 있습니다. 더 자세한 내용은 [Variables](../index-2/index.md)를 참조하시기 바랍니다.
...
만약 feed 를 제대로 제공하지 않으면 `placeholder()` 연산은 에러를 출력할 것입니다. feed를 이용하는 다른 예시는 [MNIST fully-connected feed tutorial](../index-1/undefined/index-2.md)([source code](https://www.tensorflow.org/code/tensorflow/g3doc/tutorials/mnist/fully\_connected\_feed.py))를 참조하시기 바랍니다.
