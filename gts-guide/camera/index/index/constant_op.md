...
또 다른 난수값을 사용하는 일반적인 사례는 변수들의 초기화입니다. 이 또한 [Variables How To](../../../sensor/er2/)에서 볼 수 있습니다.
...
#### `tf.multinomial(logits, num_samples, seed=None, name=None)` <a href="#multinomial" id="multinomial"></a>
